...
You'll progress through math, PyTorch, deep learning, transformers, RAG, OCR, fine-tuning, MCP, and practical data analysis — with clean, intuitive Jupyter notebooks guiding you at every step.
...
- Fine-tuning language models with Unsloth and LoRA
- JSON dataset fine-tuning workflows

### 8. MCP / YouTubeMCP
- Model Context Protocol (MCP) implementation
- YouTube-related MCP utilities
- MCP server and application examples

### 9. Brazil E-Commerce Data Analysis
- Exploratory data analysis using the Brazil E-Commerce dataset
- Analysis of orders, products, sellers, payments, reviews, and customers
- Practical data analysis notebooks using real-world datasets

### 10. Basic ML Model Implementation
- Linear Regression
- Logistic Regression
- Decision Tree
- Naive Bayes Classification
- Additional regression model implementations
...
3. Explore the additional practical sections:
   - `5.RAG/`
   - `6.OCR/`
   - `Fine-Tuning/`
   - `YoutubeMCP/`
